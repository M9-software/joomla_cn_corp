...
<div id="wrapper">
	...
	<?php include "html/com_content/archive/function.php"; ?>  
	...
	<div id="bottomwide">
		...
		<?php if ($this->params->get( 'footerdisable' )) : ?><?php echo ($footertext); ?><?php endif; ?> - <a href="http://www.freshjoomlatemplates.com/" target="_blank">Joomla Templates</a>
